...
//        private MethodSelector methodSelector;
        ...
        private MethodIteration calcuteMethods;
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            string expr1 = "1 - 0.9 * (x * cos(0.4 - 6 / (1 + x * x + y * y)) - y * sin(0.4 - 6 / (1 + x * x + y * y)))";
            string expr2 = "1.2 * (x * sin(0.4 - 6 / (1 + x * x + y * y)) + y * cos(0.4 - 6 / (1 + x * x + y * y)))";
        ...
        private void draw() {
            ...
            Gl.glTranslated(0, 0, -5 - trackBar.Value / 2);
